...
// Sample Data
const promotions = [
  { id: 1, imageUrl: 'https://placehold.co/1200x400?text=Get+50%25+Off+Fruits!', altText: 'Fruits Discount' },
  { id: 2, imageUrl: 'https://placehold.co/1200x400?text=Fresh+Vegetables+Daily!', altText: 'Fresh Vegetables' },
  { id: 3, imageUrl: 'https://placehold.co/1200x400?text=Snacks+Fiesta+-+Buy+2+Get+1', altText: 'Snacks Fiesta' },
];
...
const featuredProducts: ProductCardProps[] = [
  { id: 'fp1', slug: 'fresh-apples-1kg', name: 'Fresh Red Apples', price: 2.99, unit: '1kg', imageUrl: 'https://placehold.co/300x300/f03e3e/ffffff?text=Apples' },
  { id: 'fp2', slug: 'organic-carrots-500g', name: 'Organic Carrots', price: 1.49, unit: '500g', imageUrl: 'https://placehold.co/300x300/f08c00/ffffff?text=Carrots' },
  { id: 'fp3', slug: 'whole-milk-1l', name: 'Fresh Whole Milk', price: 1.99, unit: '1L', imageUrl: 'https://placehold.co/300x300/a9e34b/ffffff?text=Milk' },
  { id: 'fp4', slug: 'potato-chips-large', name: 'Classic Potato Chips', price: 3.20, unit: 'Large Bag', imageUrl: 'https://placehold.co/300x300/fcc419/ffffff?text=Chips' },
  { id: 'fp5', slug: 'artisan-bread-loaf', name: 'Artisan Sourdough Bread', price: 4.50, unit: '1 Loaf', imageUrl: 'https://placehold.co/300x300/864E4E/ffffff?text=Bread' },
  { id: 'fp6', slug: 'free-range-eggs-dozen', name: 'Free-Range Eggs', price: 3.99, unit: '1 Dozen', imageUrl: 'https://placehold.co/300x300/E6D5B8/ffffff?text=Eggs' },
];
